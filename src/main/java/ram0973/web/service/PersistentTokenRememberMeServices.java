...
import ram0973.web.repository.PersistentTokenRepository;
import ram0973.web.repository.PersonRepository;
import ram0973.web.utils.PersistentTokenCache;
import ram0973.web.utils.RandomUtils;
...
public class PersistentTokenRememberMeServices extends AbstractRememberMeServices {
    ...
    protected PersistentTokenRememberMeServices(
        @Value("${custom.security.remember-me.key}") String key,
        PersonDetailsService personDetailsService,
        PersistentTokenRepository persistentTokenRepository,
        PersonRepository personRepository) {

        super(key, personDetailsService);
